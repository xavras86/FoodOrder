...
insert into food_ordering_user (user_name, email, password, active) values ('marcin_customer', 'customer@interia.pl', '$2a$12$TwQsp1IusXTDl7LwZqL0qeu49Ypr6vRdEzRq2vAsgb.zvOtrnzm5G', true);
insert into food_ordering_user (user_name, email, password, active) values ('marcin_owner', 'owner@gmail.com', '$2a$12$TwQsp1IusXTDl7LwZqL0qeu49Ypr6vRdEzRq2vAsgb.zvOtrnzm5G', true);
